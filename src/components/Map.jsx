...
export default function Map() {
  return (
    <div className="justify-center flex pt-12 flex-col h-screen items-center">
      <h2 className="text-[40px] md:text-[80px] lg:text-[150px] font-primary text-center">Locate Us on</h2>
      <iframe
        ...
        className="size-[300px] md:size-[500px] lg:size-[600px] rounded-full"
        allowfullscreen=""
        loading="lazy"
